...
(DEFAULT, 'cleaning in north area', 'Cleaning', 'the company should have 50 employees or more...', 'contract about cleaning the houses in the north area', 50000, 'this is going to help alot of people', '2018-08-07', DEFAULT, DEFAULT, 'North original', 'North East', '00971', DEFAULT),
(DEFAULT, 'Catering in  area', 'Catering', 'the company should have 50 employees or more...', 'contract about Catering the houses in the north area', 100000, 'this is going to help alot of people', '2018-08-06', DEFAULT, DEFAULT, 'North comp iginal', 'South East', '01971', DEFAULT),
(DEFAULT, 'Gardening in north area', 'Gardening & Landscaping', 'the company should have 50 employees or more...', 'contract about Gardening & Landscaping the houses in the north area', 150000, 'this is going to help alot of people', '2018-10-05', DEFAULT, DEFAULT, 'North ginal', 'Yorkshire and the Humber', '04971', DEFAULT);